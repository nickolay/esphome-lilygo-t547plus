...
class T547 : public PollingComponent, public display::DisplayBuffer {
 public:
  ...
  void image(int x, int y, esphome::display::BaseImage *image,bool bNegative=false, Color color_on = esphome::display::COLOR_ON, Color color_off = esphome::display::COLOR_OFF) ;
